...
- Stage ID（本阶段叫什么）：多标的观察盘全链路（MVP＋推送＋紧凑＋导航枢纽，radar-live）
...
- docs 落盘清单：docs/pm/PRODUCT_PLAN.md（V0.2）、docs/review/RESEARCH_REVIEW.md（第2轮PASS）、docs/review/CODE_REVIEW.md（含终核PASS＋P1第二轮PASS＋核验闭环终核PASS）、docs/qa/BUGS.md（QA PASS 0新BUG×6轮）、docs/qa/SQLITE_BACKUP_RESTORE.md、docs/model/两账本（示例行已删＋真实行已落）、本HANDOFF
