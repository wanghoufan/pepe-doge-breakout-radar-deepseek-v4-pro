...
- Stage ID（本阶段叫什么）：多标的观察盘 MVP＋P1 收尾（radar-live）
...
- docs 落盘清单（本轮新增/改了哪几个 docs 文件）：docs/pm/PRODUCT_PLAN.md（V0.2）、docs/review/RESEARCH_REVIEW.md（第2轮PASS）、docs/review/CODE_REVIEW.md（含终核PASS＋P1第二轮PASS）、docs/qa/BUGS.md（QA PASS 0新BUG×2轮）、docs/qa/SQLITE_BACKUP_RESTORE.md、docs/model/两账本（示例行已删＋真实行已落）、本HANDOFF
